        ...
        <div className={styles.timeline}>
          <div className={styles.timeline_item}>
            ...
            <p className={styles.timeline_desc}>
              ...
              full-stack development Simultaneously developing projects with
              HTML, JavaScript, React, and Redux. Developed skills in remote
              pair-programming using GitHub, industry-standard gitflow, And
              daily standups to communicate and collaborate with remote
              developers.
            </p>
          </div>
        </div>
