...
const GitHubStats = () => {
  return (
    <section className={styles.Github_section} id="resume">
      ...
      <div
        className={styles.stats_calender}
        style={{
      ...
      <div className={styles.githubInfo}>
        <div>
          <div className={styles.texts}>
            <FaCode size="30px" /> <h1>1500+ Hours Practical Coding</h1>
          </div>
          <div className={styles.texts}>
            <RiLightbulbFlashLine size="30px" />{" "}
            <h1>500+ Hours Data Structures & Algorithms</h1>
          </div>
          <div className={styles.texts} alignItems="center">
        ...
        <div>
          <div className={styles.texts}>
            <AiOutlineFundProjectionScreen size="30px" /> <h1>9+ Projects</h1>
          </div>
          <div className={styles.texts}>
